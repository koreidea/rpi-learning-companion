...
class ExerciseBuddy extends Activity {
  ...
  Map<String, List<String>> get voiceTriggers => const {
    'en': ['exercise game', 'exercise time', 'let us exercise', 'workout', 'jumping game', 'move your body', 'dance game'],
    'hi': ['व्यायाम खेल', 'कसरत करो', 'शरीर हिलाओ'],
    'te': ['వ్యాయామ ఆట', 'వ్యాయామం చేద్దాం', 'శరీరం కదుపు'],
  };
