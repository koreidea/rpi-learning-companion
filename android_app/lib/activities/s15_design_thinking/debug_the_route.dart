...
class DebugTheRoute extends Activity {
  ...
  Map<String, List<String>> get voiceTriggers => const {
    'en': ['debug game', 'fix the route', 'debug the route', 'find the bug', 'fix the directions', 'spot the mistake'],
    'hi': ['गलती ढूंढो', 'बग ढूंढो', 'रास्ता ठीक करो'],
    'te': ['తప్పు కనుక్కో', 'బగ్ కనుక్కో', 'దారి సరి చెయ్యి'],
  };
