...
class MysterySolver extends Activity {
  ...
  Map<String, List<String>> get voiceTriggers => const {
    'en': [
      'mystery game', 'riddle game', 'play riddles', 'play mystery',
      'mystery', 'riddle', 'guess what', 'guessing game',
      'clue game', 'solve the mystery',
    ],
    'hi': ['पहेली', 'पहेली खेलो', 'अंदाजा लगाओ', 'रहस्य'],
    'te': ['పజిల్', 'ఊహించు', 'రహస్యం'],
  };
  ...
  static final List<_Riddle> _easyRiddles = [
    _Riddle(answer: 'cat', displayAnswer: 'a cat', acceptableAnswers: ['cat', 'kitty', 'kitten'], clues: ['It has four legs.', 'It says meow.', 'It likes to chase mice.']),
    _Riddle(answer: 'dog', displayAnswer: 'a dog', acceptableAnswers: ['dog', 'puppy', 'doggy'], clues: ['It has four legs and a tail.', 'It says woof woof.', 'It loves to fetch sticks.']),
    _Riddle(answer: 'banana', displayAnswer: 'a banana', acceptableAnswers: ['banana'], clues: ['It is a fruit.', 'It is yellow.', 'Monkeys love to eat it.']),
    _Riddle(answer: 'sun', displayAnswer: 'the sun', acceptableAnswers: ['sun'], clues: ['You can see it in the sky.', 'It is very bright and yellow.', 'It comes out during the day and goes away at night.']),
    _Riddle(answer: 'elephant', displayAnswer: 'an elephant', acceptableAnswers: ['elephant'], clues: ['It is very very big.', 'It is gray.', 'It has a long trunk and big ears.']),
    _Riddle(answer: 'fish', displayAnswer: 'a fish', acceptableAnswers: ['fish', 'fishy'], clues: ['It lives in water.', 'It can swim but cannot walk.', 'It has fins and scales.']),
  ];

  static final List<_Riddle> _mediumRiddles = [
    _Riddle(answer: 'umbrella', displayAnswer: 'an umbrella', acceptableAnswers: ['umbrella'], clues: ['You use it when it rains.', 'It opens up wide above your head.', 'It keeps you dry.', 'It can fold up small when you do not need it.']),
    _Riddle(answer: 'bicycle', displayAnswer: 'a bicycle', acceptableAnswers: ['bicycle', 'bike', 'cycle'], clues: ['It has two wheels.', 'You sit on it and use your legs.', 'It has pedals that go round and round.', 'You can ride it to the park.']),
    _Riddle(answer: 'moon', displayAnswer: 'the moon', acceptableAnswers: ['moon'], clues: ['You can see it in the sky.', 'It comes out at night.', 'Sometimes it is round, sometimes it looks like a banana.', 'It shines white in the dark sky.']),
    _Riddle(answer: 'tree', displayAnswer: 'a tree', acceptableAnswers: ['tree'], clues: ['It is alive but does not walk.', 'It is green and very tall.', 'Birds like to sit on it.', 'It has leaves and branches.']),
    _Riddle(answer: 'ice cream', displayAnswer: 'ice cream', acceptableAnswers: ['ice cream', 'icecream'], clues: ['It is a yummy treat.', 'It is very cold.', 'It comes in many flavors like chocolate and vanilla.', 'It melts if you do not eat it fast!']),
    _Riddle(answer: 'train', displayAnswer: 'a train', acceptableAnswers: ['train'], clues: ['It is very long.', 'It goes choo choo.', 'It moves on tracks.', 'Many people ride inside it to go places.']),
  ];

  static final List<_Riddle> _hardRiddles = [
    _Riddle(answer: 'doctor', displayAnswer: 'a doctor', acceptableAnswers: ['doctor', 'dr'], clues: ['This person helps people every day.', 'They wear a white coat.', 'They use a stethoscope to listen to your heart.', 'You visit them when you are sick.', 'They work in a hospital.']),
    _Riddle(answer: 'rainbow', displayAnswer: 'a rainbow', acceptableAnswers: ['rainbow'], clues: ['You can see it in the sky but you cannot touch it.', 'It has many beautiful colors.', 'It appears after the rain stops.', 'It looks like a big colorful arch.', 'It has seven colors.']),
    _Riddle(answer: 'clock', displayAnswer: 'a clock', acceptableAnswers: ['clock', 'watch'], clues: ['You can find it on the wall or on your wrist.', 'It has numbers on it.', 'It goes tick tock tick tock.', 'It has hands that move in a circle.', 'It tells you the time.']),
    _Riddle(answer: 'library', displayAnswer: 'a library', acceptableAnswers: ['library'], clues: ['It is a special place you can visit.', 'You have to be quiet there.', 'It is full of books.', 'You can borrow things and bring them back later.', 'People go there to read and learn.']),
    _Riddle(answer: 'shadow', displayAnswer: 'a shadow', acceptableAnswers: ['shadow'], clues: ['Everyone has one but you cannot pick it up.', 'It is always dark.', 'It follows you everywhere outside.', 'It changes size during the day.', 'The sun makes it appear behind you.']),
  ];
}
