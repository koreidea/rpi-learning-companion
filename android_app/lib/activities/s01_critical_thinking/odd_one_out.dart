...
class OddOneOut extends Activity {
  ...
  Map<String, List<String>> get voiceTriggers => const {
    'en': [
      'odd one out', 'which one does not belong', 'which is different',
      'classification game', 'odd one', 'find the different one',
    ],
    'hi': ['कौन अलग है', 'अलग वाला', 'कौन सा अलग'],
    'te': ['వేరేది ఏది', 'భిన్నమైనది', 'ఏది వేరు'],
  };
  ...
  List<_OddOneOutSet> _getSetsForDifficulty(int level) {
    switch (level) {
      case 0: return _easySets;
      case 1: return _mediumSets;
      case 2: return _hardSets;
      default: return _easySets;
    }
  }

  static final List<_OddOneOutSet> _easySets = [
    _OddOneOutSet(items: ['apple', 'banana', 'car', 'mango'], oddOne: 'car', oddOneAliases: [], explanation: 'the others are all fruits but a car is a vehicle'),
    _OddOneOutSet(items: ['dog', 'cat', 'chair', 'rabbit'], oddOne: 'chair', oddOneAliases: [], explanation: 'the others are all animals but a chair is furniture'),
    _OddOneOutSet(items: ['red', 'blue', 'pizza', 'green'], oddOne: 'pizza', oddOneAliases: [], explanation: 'the others are all colors but pizza is food'),
    _OddOneOutSet(items: ['shirt', 'pants', 'hat', 'football'], oddOne: 'football', oddOneAliases: ['ball', 'foot ball'], explanation: 'the others are all clothes you wear but a football is a toy'),
    _OddOneOutSet(items: ['table', 'bed', 'lion', 'sofa'], oddOne: 'lion', oddOneAliases: [], explanation: 'the others are all furniture but a lion is an animal'),
    _OddOneOutSet(items: ['milk', 'juice', 'book', 'water'], oddOne: 'book', oddOneAliases: [], explanation: 'the others are all things you drink but a book is for reading'),
  ];

  static final List<_OddOneOutSet> _mediumSets = [
    _OddOneOutSet(items: ['eagle', 'butterfly', 'sparrow', 'turtle'], oddOne: 'turtle', oddOneAliases: [], explanation: 'the others can all fly but a turtle walks on the ground'),
    _OddOneOutSet(items: ['ice cream', 'hot chocolate', 'popsicle', 'frozen yogurt'], oddOne: 'hot chocolate', oddOneAliases: ['chocolate', 'hot'], explanation: 'the others are all cold treats but hot chocolate is a warm drink'),
    _OddOneOutSet(items: ['piano', 'guitar', 'drum', 'pencil'], oddOne: 'pencil', oddOneAliases: [], explanation: 'the others are all musical instruments but a pencil is for writing'),
    _OddOneOutSet(items: ['carrot', 'potato', 'onion', 'strawberry'], oddOne: 'strawberry', oddOneAliases: ['berry'], explanation: 'the others all grow underground but a strawberry grows above the ground and it is a fruit'),
    _OddOneOutSet(items: ['rain', 'snow', 'sunshine', 'telephone'], oddOne: 'telephone', oddOneAliases: ['phone'], explanation: 'the others are all types of weather but a telephone is something you talk on'),
    _OddOneOutSet(items: ['doctor', 'teacher', 'pilot', 'banana'], oddOne: 'banana', oddOneAliases: [], explanation: 'the others are all jobs that people do but a banana is a fruit'),
  ];

  static final List<_OddOneOutSet> _hardSets = [
    _OddOneOutSet(items: ['car', 'bicycle', 'scooter', 'horse'], oddOne: 'horse', oddOneAliases: [], explanation: 'the others all have wheels but a horse has legs'),
    _OddOneOutSet(items: ['ball', 'orange', 'coin', 'box'], oddOne: 'box', oddOneAliases: [], explanation: 'the others are all round but a box has corners and flat sides'),
    _OddOneOutSet(items: ['fish', 'whale', 'dolphin', 'crab'], oddOne: 'crab', oddOneAliases: [], explanation: 'the others all swim through the water but a crab walks sideways on the bottom'),
    _OddOneOutSet(items: ['night', 'cave', 'shadow', 'lamp'], oddOne: 'lamp', oddOneAliases: ['light'], explanation: 'the others are all dark things but a lamp gives light'),
    _OddOneOutSet(items: ['river', 'ocean', 'lake', 'desert'], oddOne: 'desert', oddOneAliases: [], explanation: 'the others all have lots of water but a desert is very dry'),
    _OddOneOutSet(items: ['scissors', 'knife', 'pillow', 'needle'], oddOne: 'pillow', oddOneAliases: [], explanation: 'the others are all sharp things but a pillow is soft and fluffy'),
  ];
}
