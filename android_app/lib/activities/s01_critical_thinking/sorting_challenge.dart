...
class SortingChallenge extends Activity {
  ...
  Map<String, List<String>> get voiceTriggers => const {
    'en': ['sorting game', 'sort', 'sorting challenge', 'big or small', 'alive or not', 'hot or cold', 'can fly or not', 'classify'],
    'hi': ['छांटो', 'बड़ा या छोटा', 'जिंदा या नहीं'],
    'te': ['వర్గీకరణ', 'పెద్ద చిన్న', 'సజీవం'],
  };
