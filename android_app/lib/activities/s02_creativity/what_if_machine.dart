...
class WhatIfMachine extends Activity {
  ...
  Map<String, List<String>> get voiceTriggers => const {
    'en': ['what if', 'what would happen', 'imagination game', 'what if game', 'pretend game'],
    'hi': ['क्या होगा अगर', 'सोचो अगर', 'कल्पना'],
    'te': ['ఏమి జరుగుతుంది', 'ఊహించుకో'],
  };
